...
//
// Debug information:
// Generated date: Sun Sep 11 04:06:35 UTC 2022
...
public class movies extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("release_date", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        release_date = (java.sql.Date)value;
      }
    });
  }
  public movies() {
  ...
  public java.sql.Date get_release_date() {
    return release_date;
  }
  public void set_release_date(java.sql.Date release_date) {
    this.release_date = release_date;
  }
  public movies with_release_date(java.sql.Date release_date) {
    this.release_date = release_date;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.release_date = JdbcWritableBridge.readDate(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeDate(release_date, 3 + __off, 91, __dbStmt);
    return 3;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.release_date = new Date(__dataIn.readLong());
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.release_date) { 
        ...
        __dataOut.writeBoolean(false);
    __dataOut.writeLong(this.release_date.getTime());
    }
  }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.release_date = null; } else {
      this.release_date = java.sql.Date.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    o.release_date = (o.release_date != null) ? (java.sql.Date) o.release_date.clone() : null;
    return o;
  }
